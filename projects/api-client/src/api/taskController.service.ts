...
export class TaskControllerService {
  ...
  public getAll6(
    ...
    if (since === null || since === undefined) {
      throw new Error('Required parameter since was null or undefined when calling getAll6.');
    }
    ...
    return this.httpClient.request<Array<TaskDto>>(
      'get',
      `${this.basePath}/tasks/all/${encodeURIComponent(String(since))}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getAllActiveUuids8(observe?: 'body', reportProgress?: boolean): Observable<Array<string>>;
  public getAllActiveUuids8(
    observe?: 'response',
    reportProgress?: boolean
  ...
  public getAllActiveUuids8(
    ...
    return this.httpClient.request<Array<string>>('get', `${this.basePath}/tasks/uuids`, {
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
      reportProgress: reportProgress,
  ...
  public getByUuids22(
    ...
    return this.httpClient.request<Array<TaskDto>>('post', `${this.basePath}/tasks/query`, {
      body: body,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
  ...
  public postTasks(
    ...
    return this.httpClient.request<Array<PushResult>>('post', `${this.basePath}/tasks/push`, {
      body: body,
      withCredentials: this.configuration.withCredentials,
      headers: headers,
      observe: observe,
