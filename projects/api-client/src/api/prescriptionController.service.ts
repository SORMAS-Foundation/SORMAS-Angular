...
export class PrescriptionControllerService {
   ...
   */
  public getAllActiveUuids6(observe?: 'body', reportProgress?: boolean): Observable<Array<string>>;
  public getAllActiveUuids6(
    observe?: 'response',
  ...
  public getAllActiveUuids6(
    ...
    return this.httpClient.request<Array<string>>('get', `${this.basePath}/prescriptions/uuids`, {
  ...
  public getAllPrescriptions(
    ...
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<Array<PrescriptionDto>>;
  public getAllPrescriptions(
    since: number,
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<PrescriptionDto>>>;
  public getAllPrescriptions(
    since: number,
    observe?: 'events',
    reportProgress?: boolean
  ): Observable<HttpEvent<Array<PrescriptionDto>>>;
  public getAllPrescriptions(
    since: number,
    observe: any = 'body',
    reportProgress: boolean = false
    ...
    if (since === null || since === undefined) {
      throw new Error(
        'Required parameter since was null or undefined when calling getAllPrescriptions.'
      );
    }
    ...
    return this.httpClient.request<Array<PrescriptionDto>>(
      'get',
      `${this.basePath}/prescriptions/all/${encodeURIComponent(String(since))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public getByUuids19(
    ...
    return this.httpClient.request<Array<PrescriptionDto>>(
      'post',
      `${this.basePath}/prescriptions/query`,
      {
        body: body,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postPrescriptions(
    body?: Array<PrescriptionDto>,
    observe?: 'body',
    reportProgress?: boolean
  ...
  public postPrescriptions(
    ...
    return this.httpClient.request<Array<PushResult>>(
      'post',
      `${this.basePath}/prescriptions/push`,
      {
        body: body,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
