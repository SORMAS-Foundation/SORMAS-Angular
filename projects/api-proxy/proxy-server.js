...
app.use('/sormas-rest/persons/setMissingCoordinates', (req, res) => {
  res.status(200).send({
  ...
  for (let i = 0; i <= 10; i++) {
    arrayData.push({
      parent: {
        ...
        diseaseVariant: null,
        districtUuid: null,
        epidNumber: 'DE-BW-UL-22-',
        externalID: null,
        externalToken: null,
        followUpStatus: 'FOLLOW_UP',
        followUpUntil: 1649628000000,
        healthFacilityName: 'Elderly care facility 1',
        id: 26159,
        inJurisdiction: true,
        internalToken: null,
        ...
        personLastName: 'sdadsadsa',
        personUuid: 'QV2YJQ-F3W6CL-PLA5V5-3KTQKLNE',
        pointOfEntryName: '',
        presentCondition: null,
        pseudonymized: false,
        quarantineTo: null,
        regionUuid: null,
        reportDate: 1648418400000,
        responsibleDistrictName: 'LK Alb-Donau-Kreis',
        responsibleDistrictUuid: 'af1a0cdd-531f-5c67-a4f2-ca6997b821d6',
        responsibleRegionUuid: 'c555ccae-778d-5b0d-9ebd-8b55fb597e3b',
        sex: 'MALE',
        surveillanceOfficerUuid: 'TOGX4H-FPVTCO-NSZL5B-6Y5ISA5M',
        surveillanceToolLastShareDate: null,
        surveillanceToolShareCount: null,
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'RZNGYL-KU7LAG-BX3MP5-SU2BCN4E',
      ...
      child: {
        ...
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'YYNGYL-KU7LAG-BX3MP5-SU2BCN4E',
        vaccinationStatus: null,
        visitCount: 0,
      },
    });
    arrayData.push({
      parent: {
        ...
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'JUNGYL-KU7LAG-BX3MP5-UI2BCN4E',
        vaccinationStatus: null,
        visitCount: 0,
      },
      child: {
        ...
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'XXNGYL-KU7LAG-BX3MP5-SU2BCN4E',
        vaccinationStatus: null,
        visitCount: 0,
      },
    });
    arrayData.push({
      parent: {
        ...
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'IONGYL-KU7LAG-BX3MP5-SU2BCN4E',
        vaccinationStatus: null,
        visitCount: 0,
      },
      child: {
        ...
        surveillanceToolStatus: null,
        symptomJournalStatus: 'UNREGISTERED',
        uuid: 'ZZNGYL-KU7LAG-BX3MP5-SU2BCN4E',
        vaccinationStatus: null,
        visitCount: 0,
      },
    });
...
app.use('/sormas-rest/mergeDuplicatesContact/indexList', (req, res) => {
  const arrayData = [];
  for (let i = 0; i <= 10; i++) {
    arrayData.push({
      parent: {
