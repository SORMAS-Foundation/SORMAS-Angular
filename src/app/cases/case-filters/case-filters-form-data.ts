...
export const FORM_DATA_CASE_FILTERS = [
  {
    id: 'search',
    title: '',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        determinedBy: ['facilityTypeGroup'],
        className: 'fullwidth',
      },
      {
        ...FORM_DATA_SELECT,
        ...
        determinedBy: ['district.uuid', 'community.uuid', 'facilityTypeGroup', 'facilityType'],
        determinedByMandatory: [true, false, true, true],
        className: 'fullwidth',
      },
    ],
  },
