...
export const FORM_DATA_CASE_EPID_DETAILS = [
  ...
  },
  {
    ...
    subTitle: _('Please indicate if any of the following is relevant for the patient during the incubation period'),
    fields: [
      {
        ...FORM_DATA_RADIO,
      ...
      },
      {
        ...
        label: _('Residing or traveling to countries/territories/areas experiencing larger outbreaks of local transmission'),
        options: optionsYesNoUnknown,
      },
    ],
  },
  {
    ...
    subTitle: _('Please indicate ALL contacts with potential source cases during the incubation period'),
    fields: [
      {
        ...FORM_DATA_RADIO,
