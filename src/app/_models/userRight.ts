...
export const UserRight = {
  ...
  IMMUNIZATIONMANAGEMENTACCESS: 'IMMUNIZATION_MANAGEMENT_ACCESS' as UserRight,
  IMMUNIZATIONVIEW: 'IMMUNIZATION_VIEW' as UserRight,
  IMMUNIZATIONCREATE: 'IMMUNIZATION_CREATE' as UserRight,
  IMMUNIZATIONEDIT: 'IMMUNIZATION_EDIT' as UserRight,
  IMMUNIZATIONDELETE: 'IMMUNIZATION_DELETE' as UserRight,
  IMMUNIZATIONARCHIVE: 'IMMUNIZATION_ARCHIVE' as UserRight,
  PERSONVIEW: 'PERSON_VIEW' as UserRight,
  PERSONEDIT: 'PERSON_EDIT' as UserRight,
  PERSONDELETE: 'PERSON_DELETE' as UserRight,
  PERSONCONTACTDETAILSDELETE: 'PERSON_CONTACT_DETAILS_DELETE' as UserRight,
  PERSONEXPORT: 'PERSON_EXPORT' as UserRight,
  ...
  CONTACTMERGE: 'CONTACT_MERGE' as UserRight,
  ...
  EVENTIMPORT: 'EVENT_IMPORT' as UserRight,
  ...
  EVENTGROUPCREATE: 'EVENTGROUP_CREATE' as UserRight,
  EVENTGROUPEDIT: 'EVENTGROUP_EDIT' as UserRight,
  EVENTGROUPLINK: 'EVENTGROUP_LINK' as UserRight,
  EVENTGROUPARCHIVE: 'EVENTGROUP_ARCHIVE' as UserRight,
  EVENTGROUPDELETE: 'EVENTGROUP_DELETE' as UserRight,
  ...
  PERFORMBULKOPERATIONSEVENT: 'PERFORM_BULK_OPERATIONS_EVENT' as UserRight,
  ...
  PERFORMBULKOPERATIONSLABMESSAGES: 'PERFORM_BULK_OPERATIONS_LAB_MESSAGES' as UserRight,
  TRAVELENTRYMANAGEMENTACCESS: 'TRAVEL_ENTRY_MANAGEMENT_ACCESS' as UserRight,
  TRAVELENTRYVIEW: 'TRAVEL_ENTRY_VIEW' as UserRight,
  TRAVELENTRYCREATE: 'TRAVEL_ENTRY_CREATE' as UserRight,
  TRAVELENTRYEDIT: 'TRAVEL_ENTRY_EDIT' as UserRight,
  TRAVELENTRYDELETE: 'TRAVEL_ENTRY_DELETE' as UserRight,
  TRAVELENTRYARCHIVE: 'TRAVEL_ENTRY_ARCHIVE' as UserRight,
};
