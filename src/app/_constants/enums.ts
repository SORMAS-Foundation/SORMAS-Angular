...
export enum FacilityType {
  ASSOCIATION = 'enum.FacilityType.ASSOCIATION',
  BAR = 'enum.FacilityType.BAR',
  BUSINESS = 'enum.FacilityType.BUSINESS',
  CAMPSITE = 'enum.FacilityType.CAMPSITE',
  CANTINE = 'enum.FacilityType.CANTINE',
  CHILDRENS_DAY_CARE = 'enum.FacilityType.CHILDRENS_DAY_CARE',
  CHILDRENS_HOME = 'enum.FacilityType.CHILDRENS_HOME',
  CORRECTIONAL_FACILITY = 'enum.FacilityType.CORRECTIONAL_FACILITY',
  CRUISE_SHIP = 'enum.FacilityType.CRUISE_SHIP',
  ELDERLY_DAY_CARE = 'enum.FacilityType.ELDERLY_DAY_CARE',
  EVENT_VENUE = 'enum.FacilityType.EVENT_VENUE',
  FOOD_STALL = 'enum.FacilityType.FOOD_STALL',
  HOLIDAY_CAMP = 'enum.FacilityType.HOLIDAY_CAMP',
  HOMELESS_SHELTER = 'enum.FacilityType.HOMELESS_SHELTER',
  HOSPITAL = 'enum.FacilityType.HOSPITAL',
  HOSTEL = 'enum.FacilityType.HOSTEL',
  HOTEL = 'enum.FacilityType.HOTEL',
  KINDERGARTEN = 'enum.FacilityType.KINDERGARTEN',
  LABORATORY = 'enum.FacilityType.LABORATORY',
  MASS_ACCOMMODATION = 'enum.FacilityType.MASS_ACCOMMODATION',
  MILITARY_BARRACKS = 'enum.FacilityType.MILITARY_BARRACKS',
  MOBILE_NURSING_SERVICE = 'enum.FacilityType.MOBILE_NURSING_SERVICE',
  NIGHT_CLUB = 'enum.FacilityType.NIGHT_CLUB',
  OTHER_ACCOMMODATION = 'enum.FacilityType.OTHER_ACCOMMODATION',
  OTHER_CARE_FACILITY = 'enum.FacilityType.OTHER_CARE_FACILITY',
  OTHER_CATERING_OUTLET = 'enum.FacilityType.OTHER_CATERING_OUTLET',
  OTHER_EDUCATIONAL_FACILITY = 'enum.FacilityType.OTHER_EDUCATIONAL_FACILITY',
  OTHER_LEISURE_FACILITY = 'enum.FacilityType.OTHER_LEISURE_FACILITY',
  OTHER_MEDICAL_FACILITY = 'enum.FacilityType.OTHER_MEDICAL_FACILITY',
  OTHER_RESIDENCE = 'enum.FacilityType.OTHER_RESIDENCE',
  OTHER_WORKING_PLACE = 'enum.FacilityType.OTHER_WORKING_PLACE',
  OTHER_COMMERCE = 'enum.FacilityType.OTHER_COMMERCE',
  OUTPATIENT_TREATMENT_FACILITY = 'enum.FacilityType.OUTPATIENT_TREATMENT_FACILITY',
  PLACE_OF_WORSHIP = 'enum.FacilityType.PLACE_OF_WORSHIP',
  PUBLIC_PLACE = 'enum.FacilityType.PUBLIC_PLACE',
  REFUGEE_ACCOMMODATION = 'enum.FacilityType.REFUGEE_ACCOMMODATION',
  REHAB_FACILITY = 'enum.FacilityType.REHAB_FACILITY',
  RESTAURANT = 'enum.FacilityType.RESTAURANT',
  RETIREMENT_HOME = 'enum.FacilityType.RETIREMENT_HOME',
  SCHOOL = 'enum.FacilityType.SCHOOL',
  SWIMMING_POOL = 'enum.FacilityType.SWIMMING_POOL',
  THEATER = 'enum.FacilityType.THEATER',
  UNIVERSITY = 'enum.FacilityType.UNIVERSITY',
  ZOO = 'enum.FacilityType.ZOO',
  RETAIL = 'enum.FacilityType.RETAIL',
  WHOLESALE = 'enum.FacilityType.WHOLESALE',
  AMBULATORY_SURGERY_FACILITY = 'enum.FacilityType.AMBULATORY_SURGERY_FACILITY',
  DIALYSIS_FACILITY = 'enum.FacilityType.DIALYSIS_FACILITY',
  DAY_HOSPITAL = 'enum.FacilityType.DAY_HOSPITAL',
  MATERNITY_FACILITY = 'enum.FacilityType.MATERNITY_FACILITY',
  MEDICAL_PRACTICE = 'enum.FacilityType.MEDICAL_PRACTICE',
  DENTAL_PRACTICE = 'enum.FacilityType.DENTAL_PRACTICE',
  OTHER_MEDICAL_PRACTICE = 'enum.FacilityType.OTHER_MEDICAL_PRACTICE',
  DIAGNOSTIC_PREVENTATIVE_THERAPEUTIC_FACILITY = 'enum.FacilityType.DIAGNOSTIC_PREVENTATIVE_THERAPEUTIC_FACILITY',
  EMERGENCY_MEDICAL_SERVICES = 'enum.FacilityType.EMERGENCY_MEDICAL_SERVICES',
  ELDERLY_CARE_FACILITY = 'enum.FacilityType.ELDERLY_CARE_FACILITY',
  DISABLED_PERSON_HABITATION = 'enum.FacilityType.DISABLED_PERSON_HABITATION',
  CARE_RECIPIENT_HABITATION = 'enum.FacilityType.CARE_RECIPIENT_HABITATION',
  VISITING_AMBULATORY_AID = 'enum.FacilityType.VISITING_AMBULATORY_AID',
  AFTER_SCHOOL = 'enum.FacilityType.AFTER_SCHOOL',
}
...
export enum Language {
  ...
  FR_FR = 'enum.Language.FR',
  FR_CH = 'enum.Language.FR_CH',
  DE_DE = 'enum.Language.DE',
  DE_CH = 'enum.Language.DE_CH',
  ES_EC = 'enum.Language.ES_EC',
  ES_CU = 'enum.Language.ES_CU',
  IT_IT = 'enum.Language.IT',
  IT_CH = 'enum.Language.IT_CH',
  FI_FI = 'enum.Language.FI',
  PS_AF = 'enum.Language.PS',
  FA_AF = 'enum.Language.FA',
  CZ_CZ = 'enum.Language.CZ',
}
